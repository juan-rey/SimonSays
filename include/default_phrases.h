...
#define DEFAULT_FREQUENT_PHRASES_CATEGORIES_ALL_LANGUAGES \
  std::vector<std::pair<std::wstring, std::vector<std::pair<std::wstring, std::wstring>>>>{ \
    ...
    { L"Catalan", { \
      ...
      { L"Frases de Negocis", L"Bon dia|Com está?|Encantat de conèixer-lo|Gràcies pel seu temps|Li ho agraeixo|Amb ganes|Si us plau, enviï els detalls|Programem una reunió|Podem reprogramar?|Faré seguiment" }, \
    ...
    { L"French", { \
      ...
      { L"Sozial", L"Ça va?|Je vais bien, merci|Félicitations|Joyeux anniversaire|Bonne chance|Bien joué|C'est intéressant|Racontez-moi|À bientôt" }, \
    ...
    { L"German", { \
      ...
      { L"Reise Sätze", L"Wo ist die Toilette?|Wie viel kostet das?|Ich verstehe nicht|Sprechen Sie Englisch?|Wo bin ich?|Ich brauche ein Taxi|Bringen Sie mich zum Flughafen|Wie spät ist es?|Könnten Sie es mir auf der Karte zeigen?|Ist dieser Platz frei?" }, \
    ...
    { L"Italian", { \
      ...
      { L"Saluti Frequenti", L"Ciao|Ehi|Salve|Benvenuto|Piacere di conocerti|Che piacere vederti|È da tanto!|Come va?|Buongiorno|Buon pomeriggio|Buonasera|Buonanotte|Arrivederci|A presto|A dopo|Ci vediamo|A domani|Stammi bene|Un abbraccio|Alla prossima" }, \
    ...
    { L"Korean", { \
      ...
      { L"여행", L"화장실이 어디예요|얼마예요|이해가 안 돼요|영어 하세요?|여기가 어디예요?|택시가 필요해요|공항으로 데려다 주세요|지금 몇 시예요|지도에서 보여 주실 수 있나요?|이 자리 비웠나요" }, \
    ...
    { L"Spanish", { \
      ...
      { L"Social", L"¿Qué tal?|Estoy bien, gracias|Felicidades|Feliz cumpleaños|Buena suerte|Bien hecho|Qué interesante|Cuéntame más|Hasta pronto" }, \
    ...
    { L"Valencian", { \
      ...
      { L"Salutacions Freqüentes", L"Hola|Bones|Ei|Eiii|Benvingut|Encantat de veure't|Com va?|Quant de temps|Bon dia|Bona vesprada|Bona nit|Adéu|Adeu-siau|Fins ara|Fins després|Ens veiem|Fins demà|Cuida't|Un abraç" }, \
      ...
      { L"Frases de Viatge", L"On és el lavabo?|Quant costa?|No ho entenc|Parla anglés?|On sóc?|Necesito un taxi|Porta'm a l'aeroport|Quina hora és?|M'ho pot mostrar al mapa?|Este seient està ocupat?" }, \
