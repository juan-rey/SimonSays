...
#define DEFAULT_FREQUENT_PHRASES_CATEGORIES_ALL_LANGUAGES \
  std::vector<std::pair<std::wstring, std::vector<std::pair<std::wstring, std::wstring>>>>{ \
    { L"Arabic", { \
      ...
      { L"أصوات", L"تصفيق::applause.wav|ضحك::laugh.wav|بيب::beep.wav|رنين الهاتف::phone_ring.wav|جرس الباب::doorbell.wav|تنبيه::alert.wav|فشل::fail.wav|ألعاب نارية::shots.wav" } \
    } }, \
    { L"Basque", { \
      ...
      { L"Soinuak", L"Txaloak::applause.wav|Barreak::laugh.wav|Bip::beep.wav|Telefonoa::phone_ring.wav|Ate-txirrina::doorbell.wav|Alerta::alert.wav|Pausoa::fail.wav|Tiroketak::shots.wav" } \
    } }, \
    { L"Catalan", { \
      ...
      { L"Sons", L"Aplaudiments::applause.wav|Rialla::laugh.wav|Bip::beep.wav|Telèfon::phone_ring.wav|Timbre::doorbell.wav|Alerta::alert.wav|Risita malvada::evil_laugh.wav|Fallo::fail.wav|Tiroteig::shots.wav" } \
    } }, \
    { L"Chinese (Simplified)", { \
      ...
      { L"声音", L"掌声::applause.wav|笑声::laugh.wav|哔声::beep.wav|电话铃声::phone_ring.wav|门铃::doorbell.wav|警报::alert.wav|恶作剧声音::evil_laugh.wav|失败::fail.wav|枪声::shots.wav" } \
    } }, \
    { L"English", { \
      ...
      { L"Sounds", L"Applause::applause.wav|Laugh::laugh.wav|Beep::beep.wav|Phone ring::phone_ring.wav|Doorbell::doorbell.wav|Alert::alert.wav|Boo::boo.wav|Drumroll::drumroll.wav|Evil laugh::evil_laugh.wav|Fail::fail.wav|Shots::shots.wav" } \
    } }, \
    { L"French", { \
      ...
      { L"Sons", L"Applaudissements::applause.wav|Rire::laugh.wav|Bip::beep.wav|Téléphone::phone_ring.wav|Sonnette::doorbell.wav|Alerte::alert.wav|Bouh::boo.wav|Rouleau de tambour::drumroll.wav|Rire diabolique::evil_laugh.wav|Échec::fail.wav|Tirs::shots.wav" } \
    } }, \
    { L"Galician", { \
      ...
      { L"Frases de Negocios", L"Bos días|Como está?|Encantado de conhecelo|Grazas polo seu tempo|Agradézollo|Con ganas|Por favor envíe os detalles|Programemos unha reunión|Podemos reprogramar?|Farei seguimento" }, \
      ...
      { L"Sons", L"Aplausos::applause.wav|Risos::laugh.wav|Bip::beep.wav|Teléfono::phone_ring.wav|Campá::doorbell.wav|Alerta::alert.wav|Risita malvada::evil_laugh.wav|Fallo::fail.wav|Tiroteo::shots.wav" } \
    } }, \
    { L"German", { \
      ...
      { L"Sounds", L"Applaus::applause.wav|Lachen::laugh.wav|Piepton::beep.wav|Telefonklingeln::phone_ring.wav|Türklingel::doorbell.wav|Alarm::alert.wav|Uuuh::boo.wav|Trommelwirbel::drumroll.wav|Teuflisches Lachen::evil_laugh.wav|Fehler::fail.wav|Schüsse::shots.wav" } \
    } }, \
    { L"Hebrew", { \
      ...
      { L"צלילים", L"מחיאות כפיים::applause.wav|צחוק::laugh.wav|ביפ::beep.wav|טלפון מצלצל::phone_ring.wav|פעמון דלת::doorbell.wav|התראה::alert.wav|בוז::boo.wav|ורטיגו::drumroll.wav|צחוק רשע::evil_laugh.wav|כישלון::fail.wav|ירי::shots.wav" } \
    } }, \
    { L"Hindi", { \
      ...
      { L"व्यवसाय वाक्य", L"सुप्रभात|आप कैसे हैं|आपसे मिलकर खुशी हुई|आपके समय के लिए धन्यवाद|मैं आभारी हूँ|मैं उत्सुक हूँ|कृपया विवरण भेजें|आइएmeeting तय करें|क्या हम समय बदल सकते हैं?|मैं फॉलो-अप करूँगा/करूँगी" }, \
      ...
      { L"ध्वनियाँ", L"तालियाँ::applause.wav|हँसी::laugh.wav|बीप::beep.wav|फ़ोन की घंटी::phone_ring.wav|डोरबेल::doorbell.wav|अलर्ट::alert.wav|बू::boo.wav|ड्रमरोल::drumroll.wav|शैतानी हँसी::evil_laugh.wav|असफलता::fail.wav|गोलीबारी::shots.wav" } \
    } }, \
    { L"Italian", { \
      ...
      { L"Frasi di Viaggio", L"Dov'è il bagno?|Quanto costa?|Non capisco|Parli inglese?|Dove sono?|Ho bisogno di un taxi|Portami all'aeroporto|Che ore sono?|Puoi mostrarmelo sulla mappa?|Questo posto è libero?" }, \
      { L"Frasi di Affari", L"Buongiorno|Come sta?|Piacere di conocerli|Grazie per il suo tempo|La apprezzo|Non vedo l'ora|Per favore invii i dettagli|Programmiamo una riunione|Possiamo riprogrammare?|Farò seguito" }, \
      ...
      { L"Suoni", L"Applausi::applause.wav|Risata::laugh.wav|Beep::beep.wav|Suoneria::phone_ring.wav|Campanello::doorbell.wav|Allarme::alert.wav|Urlo::boo.wav|Rullo di tamburi::drumroll.wav|Risata diabolica::evil_laugh.wav|Fallimento::fail.wav|Spari::shots.wav" } \
    } }, \
    { L"Japanese", { \
      ...
      { L"健康のフレーズ", L"医者が必要です|私は...にアレルギーがあります|熱があります|糖尿病です|薬が必要です|救急はどこですか|私はめまいがします|息ができない|ア痛みがここに" }, \
      { L"家族と家", L"お母さん|お父さん|兄弟|姉妹|家にいます|携帯はどこですか|夕食はできていますか|出かけます|すぐ戻ります|おやすみなさい" }, \
      { L"時間と日付", L"今何時ですか|今日|明日|昨日|1時間後|今|後で|今朝|今晩|来週" }, \
      { L"音", L"拍手::applause.wav|笑い::laugh.wav|ビープ::beep.wav|着信音::phone_ring.wav|ドアベル::doorbell.wav|警告::alert.wav|悪ふざけ::boo.wav|ドラムロール::drumroll.wav|悪役の笑い::evil_laugh.wav|失敗::fail.wav|銃声::shots.wav" } \
    } }, \
    { L"Korean", { \
      ...
      { L"소리", L"박수::applause.wav|웃음::laugh.wav|삐 소리::beep.wav|전화벨::phone_ring.wav|초인종::doorbell.wav|경고::alert.wav|부우::boo.wav|드럼롤::drumroll.wav|악당의 웃음::evil_laugh.wav|실패::fail.wav|총소리::shots.wav" } \
    } }, \
    { L"Portuguese", { \
      ...
      { L"Frases de Negócios", L"Bom dia|Como está?|Prazer em conhecê-lo|Obrigado pelo seu tempo|Agradeço|Aguardando com expectativa|Por favor envie os detalhes|Agendemos uma reunião|Podemos reagendar?|Vou acompanhar" }, \
      ...
      { L"Sons", L"Aplausos::applause.wav|Riso::laugh.wav|Beep::beep.wav|Toque do telefone::phone_ring.wav|Campainha::doorbell.wav|Alerta::alert.wav|Uhu::boo.wav|Rufar de tambores::drumroll.wav|Risada maligna::evil_laugh.wav|Falha::fail.wav|Disparos::shots.wav" } \
    } }, \
    { L"Russian", { \
      ...
      { L"Фразы о здоровье", L"Мне нужен врач|У меня аллергия на...|У меня температура|Я диабетик|Мне нужны лекарства|Где неотложка?|Я чувствую головокружение|Мне трудно дышать|Боль здесь" }, \
      ...
      { L"Звуки", L"Раз, два, три!::applause.wav|Ха-ха!::laugh.wav|Бип!::beep.wav|Звонок телефона::phone_ring.wav|Дверной звонок::doorbell.wav|Предупреждение::alert.wav|Упс!::boo.wav|Барабанная дробь::drumroll.wav|Злобный смех::evil_laugh.wav|Провал::fail.wav|Выстрелы::shots.wav" } \
    } }, \
    { L"Spanish", { \
      ...
      { L"Frases de Viaje", L"¿Dónde está el baño?|¿Cuánto cuesta?|No entiendo|¿Habla inglés?|¿Dónde estoy?|Necesito un taxi|Lléveme al aeropuerto|¿Qué horas son?|¿Puede mostrarme en el mapa?|¿Está ocupado este asiento?" }, \
      ...
      { L"Familia y Hogar", L"Mamá|Papá|Hermano|Hermana|Estoy en casa|¿Dónde está mi teléfono?|El comedor está listo?|Me voy|Vuelvo enseguida|Buenas noches" }, \
      { L"Tiempo y Fecha", L"¿Qué hora es?|Hoy|Mañana|Ayer|En una hora|Ahora|Más tarde|Esta mañana|Esta noche|La próxima semana" }, \
      { L"Sonidos", L"Aplausos::applause.wav|Risa::laugh.wav|Bip::beep.wav|Teléfono::phone_ring.wav|Timbre::doorbell.wav|Alerta::alert.wav|Abucheo::boo.wav|Redoble de tambor::drumroll.wav|Risa maligna::evil_laugh.wav|Error::fail.wav|Disparos::shots.wav" } \
    } }, \
    { L"Valencian", { \
      ...
      { L"Frases Corteses", L"Per favor|Gràcies|De res|Disculpe|Perdone|Puc...?|Em pot ajudar?|Li ho agraïsc|Que tinga un bo dia|Em sap greu" }, \
