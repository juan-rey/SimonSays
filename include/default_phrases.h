...
#define DEFAULT_FREQUENT_PHRASES_CATEGORIES_ALL_LANGUAGES \
  std::vector<std::pair<std::wstring, std::vector<std::pair<std::wstring, std::wstring>>>>{ \
    { L"Arabic", { \
      ...
      { L"🔊##أصوات", L"تنبيه::alert.mp3|بيب::beep.mp3|صرخة::scream.mp3|تصفيق::applause.mp3|ضحك::laugh.mp3|آآه::aww.mp3|استهجان::boo.mp3|قرع الطبول::drumroll.mp3|فشل::fail.mp3|ضحكة شريرة::evil_laugh.mp3|جرس الباب::doorbell.mp3|رنين الهاتف::phone_ring.mp3|ألعاب نارية::shots.mp3|رقابة::censor.mp3" } \
    } }, \
    { L"Basque", { \
      ...
      { L"🔊##Soinuak", L"Alerta::alert.mp3|Bip::beep.mp3|Garrasia::scream.mp3|Txaloak::applause.mp3|Barreak::laugh.mp3|Ooo::aww.mp3|Txistuak::boo.mp3|Danborrada::drumroll.mp3|Hutsegitea::fail.mp3|Irri zitala::evil_laugh.mp3|Ate-txirrina::doorbell.mp3|Telefonoa::phone_ring.mp3|Tiroketak::shots.mp3|Zentsura::censor.mp3" } \
    } }, \
    { L"Catalan", { \
      ...
      { L"🔊##Sons", L"Alerta::alert.mp3|Bip::beep.mp3|Crit::scream.mp3|Aplaudiments::applause.mp3|Rialla::laugh.mp3|Ooh::aww.mp3|Escridassada::boo.mp3|Roc de tambor::drumroll.mp3|Fallo::fail.mp3|Rialla malvada::evil_laugh.mp3|Timbre::doorbell.mp3|Telèfon::phone_ring.mp3|Tiroteig::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"Chinese (Simplified)", { \
      ...
      { L"🔊##声音", L"警报::alert.mp3|哔声::beep.mp3|尖叫声::scream.mp3|掌声::applause.mp3|笑声::laugh.mp3|噢::aww.mp3|嘘声::boo.mp3|鼓声::drumroll.mp3|失败::fail.mp3|邪恶的笑声::evil_laugh.mp3|门铃::doorbell.mp3|电话铃声::phone_ring.mp3|枪声::shots.mp3|审查::censor.mp3" } \
    } }, \
    { L"English", { \
      ...
      { L"🔊##Sounds", L"Alert::alert.mp3|Beep::beep.mp3|Scream::scream.mp3|Applause::applause.mp3|Laugh::laugh.mp3|Aww::aww.mp3|Boo::boo.mp3|Drumroll::drumroll.mp3|Fail::fail.mp3|Evil laugh::evil_laugh.mp3|Doorbell::doorbell.mp3|Phone ring::phone_ring.mp3|Shots::shots.mp3|Censorship::censor.mp3" } \
    } }, \
    { L"French", { \
      ...
      { L"🔊##Sons", L"Alerte::alert.mp3|Bip::beep.mp3|Cri::scream.mp3|Applaudissements::applause.mp3|Rire::laugh.mp3|Ooh::aww.mp3|Bouh::boo.mp3|Roulement de tambour::drumroll.mp3|Échec::fail.mp3|Rire diabolique::evil_laugh.mp3|Sonnette::doorbell.mp3|Téléphone::phone_ring.mp3|Tirs::shots.mp3|Censure::censor.mp3" } \
    } }, \
    { L"Galician", { \
      ...
      { L"🔊##Sons", L"Alerta::alert.mp3|Bip::beep.mp3|Berro::scream.mp3|Aplausos::applause.mp3|Risos::laugh.mp3|Ooh::aww.mp3|Abucheo::boo.mp3|Redobre de tambor::drumroll.mp3|Fallo::fail.mp3|Risa malvada::evil_laugh.mp3|Campá::doorbell.mp3|Teléfono::phone_ring.mp3|Tiroteo::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"German", { \
      ...
      { L"🔊##Sounds", L"Alarm::alert.mp3|Piepton::beep.mp3|Schrei::scream.mp3|Applaus::applause.mp3|Lachen::laugh.mp3|Aww::aww.mp3|Uuuh::boo.mp3|Trommelwirbel::drumroll.mp3|Fehler::fail.mp3|Teuflisches Lachen::evil_laugh.mp3|Türklingel::doorbell.mp3|Telefonklingeln::phone_ring.mp3|Schüsse::shots.mp3|Zensur::censor.mp3" } \
    } }, \
    { L"Hebrew", { \
      ...
      { L"🔊##צלילים", L"התראה::alert.mp3|ביפ::beep.mp3|צרחות::scream.mp3|מחיאות כפיים::applause.mp3|צחוק::laugh.mp3|אוו::aww.mp3|בוז::boo.mp3|תיפוף תופים::drumroll.mp3|כישלון::fail.mp3|צחוק רשע::evil_laugh.mp3|פעמון דלת::doorbell.mp3|טלפון מצלצל::phone_ring.mp3|ירי::shots.mp3|צנזורה::censor.mp3" } \
    } }, \
    { L"Hindi", { \
      ...
      { L"🔊##ध्वनियाँ", L"अलर्ट::alert.mp3|बीप::beep.mp3|चीख::scream.mp3|तालियाँ::applause.mp3|हँसी::laugh.mp3|आह::aww.mp3|बू::boo.mp3|ड्रमरोल::drumroll.mp3|असफलता::fail.mp3|शैतानी हँसी::evil_laugh.mp3|डोरबेल::doorbell.mp3|फ़ोन की घंटी::phone_ring.mp3|गोलीबारी::shots.mp3|सेंसरशिप::censor.mp3" } \
    } }, \
    { L"Italian", { \
      ...
      { L"🔊##Suoni", L"Allarme::alert.mp3|Beep::beep.mp3|Urlo::scream.mp3|Applausi::applause.mp3|Risata::laugh.mp3|Ooh::aww.mp3|Buu::boo.mp3|Rullo di tamburi::drumroll.mp3|Fallimento::fail.mp3|Risata diabolica::evil_laugh.mp3|Campanello::doorbell.mp3|Suoneria::phone_ring.mp3|Spari::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"Japanese", { \
      ...
      { L"🔊##音", L"警告::alert.mp3|ビープ::beep.mp3|悲鳴::scream.mp3|拍手::applause.mp3|笑い::laugh.mp3|アウ::aww.mp3|ブーイング::boo.mp3|ドラムロール::drumroll.mp3|失敗::fail.mp3|悪役の笑い::evil_laugh.mp3|ドアベル::doorbell.mp3|電話ベル::phone_ring.mp3|銃声::shots.mp3|検閲::censor.mp3" } \
    } }, \
    { L"Korean", { \
      ...
      { L"🔊##소리", L"경고::alert.mp3|삐 소리::beep.mp3|비명::scream.mp3|박수::applause.mp3|웃음::laugh.mp3|아::aww.mp3|부우::boo.mp3|드럼롤::drumroll.mp3|실패::fail.mp3|악당의 웃음::evil_laugh.mp3|초인종::doorbell.mp3|전화벨::phone_ring.mp3|총소리::shots.mp3|검열::censor.mp3" } \
    } }, \
    { L"Portuguese", { \
      ...
      { L"🔊##Sons", L"Alerta::alert.mp3|Bip::beep.mp3|Grito::scream.mp3|Aplausos::applause.mp3|Riso::laugh.mp3|Ooh::aww.mp3|Vaia::boo.mp3|Rufar de tambores::drumroll.mp3|Falha::fail.mp3|Gargalhada maléfica::evil_laugh.mp3|Campainha::doorbell.mp3|Toque do telefone::phone_ring.mp3|Disparos::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"Portuguese (Brazil)", { \
      ...
      { L"🔊##Sons", L"Alerta::alert.mp3|Beep::beep.mp3|Grito::scream.mp3|Aplausos::applause.mp3|Riso::laugh.mp3|Ooh::aww.mp3|Uhu::boo.mp3|Rufar de tambores::drumroll.mp3|Falha::fail.mp3|Risada maligna::evil_laugh.mp3|Campainha::doorbell.mp3|Toque do telefone::phone_ring.mp3|Disparos::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"Russian", { \
      ...
      { L"🔊##Звуки", L"Предупреждение::alert.mp3|Бип!::beep.mp3|Крик::scream.mp3|Аплодисменты::applause.mp3|Смех::laugh.mp3|Ооо::aww.mp3|Буу::boo.mp3|Барабанная дробь::drumroll.mp3|Провал::fail.mp3|Злобный смех::evil_laugh.mp3|Дверной звонок::doorbell.mp3|Звонок телефона::phone_ring.mp3|Выстрелы::shots.mp3|Цензура::censor.mp3" } \
    } }, \
    { L"Spanish", { \
      ...
      { L"🗣️##Frases de Conversación", L"Sí|No|Vale|Muy bien|Tal vez|Ayuda|¡Espera!|Déjame terminar|Necesito un momento|Más despacio, por favor|¿Puedes repetir?|¿Qué?|No entiendo|Entiendo|No sé|¡Qué bien!|¡Qué mal!|Por favor|¡Muchas gracias!|De nada|Perdón|Lo siento|Dime" }, \
      ...
      { L"🔊##Sonidos", L"Alerta::alert.mp3|Bip::beep.mp3|Grito::scream.mp3|Aplausos::applause.mp3|Risa::laugh.mp3|Ooh::aww.mp3|Abucheo::boo.mp3|Redoble de tambor::drumroll.mp3|Error::fail.mp3|Risa maligna::evil_laugh.mp3|Timbre::doorbell.mp3|Teléfono::phone_ring.mp3|Disparos::shots.mp3|Censura::censor.mp3" } \
    } }, \
    { L"Valencian", { \
