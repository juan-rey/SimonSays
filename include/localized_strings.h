...
- **Language labels**: choose UI language (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hind)HELP" LR"HELP(i, Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
- **Idioma de la interfaz**: elegir idioma de UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, )HELP" LR"HELP(Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
- **لغة الواجهة**: اختيار لغة واجهة المستخدم (English, Spanish, Arabic, Basque, Catalan)HELP" LR"HELP(, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
- **Ahotsa**:)HELP" LR"HELP( instalatutako SAPI ahotsa hautatu zure hobespenen arabera.
...
- **Idioma de la interfície**: tria l'idioma de la UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian, Ja)HELP" LR"HELP(panese, Korean, Portuguese, Russian, Valencian).
...
- **界面语言**：选择 UI 语言（English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), Fre)HELP" LR"HELP(nch, Galician, German, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Russian, Valencian）。
...
- **Langue de l'interface** : choisir la langue de l'UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Rus)HELP" LR"HELP(sian, Valencian).
...
- **Voz**: seleccionar a voz SAPI instalada segundo a túa pref)HELP" LR"HELP(erencia.
...
- **Stimme**: Installierte SAPI-Stimme entsprechend Ihrer )HELP" LR"HELP(Präferenz auswählen.
...
- **שפת ממשק**: בחר שפת UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplifie)HELP" LR"HELP(d), French, Galician, German, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
- **इंटरफ़ेस भाषा**: UI भाषा चुनें (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Russi)HELP" LR"HELP(an, Valencian)।
...
- )HELP" LR"HELP(**Voce**: seleziona una voce SAPI installata in base alla tua preferenza.
...
- **インターフェース言語**: UI 言語を選択（English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian,)HELP" LR"HELP( Japanese, Korean, Portuguese, Russian, Valencian）。
...
- **인터페이스 언어**: UI 언어 선택 (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, Germa)HELP" LR"HELP(n, Hebrew, Hindi, Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
)HELP" LR"HELP(- **Voz**: selecionar voz SAPI instalada de acordo com a sua preferência.
...
- **Язык интерфейса**: выбрать язык UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, He)HELP" LR"HELP(brew, Hindi, Italian, Japanese, Korean, Portuguese, Russian, Valencian).
...
- **Idioma de la interfície**: tria l'idioma de la UI (English, Spanish, Arabic, Basque, Catalan, Chinese (Simplified), French, Galician, German, Hebrew, Hindi, Italian, Japanese)HELP" LR"HELP(, Korean, Portuguese, Russian, Valencian).
