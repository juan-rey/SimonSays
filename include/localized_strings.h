...
static const std::vector<std::pair<int, const wchar_t *>> DEFAULT_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays could not save your categories and phrases.\n\nYour change is still shown here, but it may be lost when SimonSays closes. Export your board with F10 to keep a copy." },
...
static const std::vector<std::pair<int, const wchar_t *>> SPANISH_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays no ha podido guardar tus categorías y frases.\n\nTu cambio sigue aquí, pero puede perderse al cerrar SimonSays. Exporta tu tablero con F10 para conservar una copia." },
...
static const std::vector<std::pair<int, const wchar_t *>> ARABIC_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"تعذّر على SimonSays حفظ فئاتك وعباراتك.\n\nتغييرك ما زال ظاهراً هنا، لكنه قد يُفقد عند إغلاق SimonSays. صدّر لوحتك بالمفتاح F10 للاحتفاظ بنسخة." },
...
static const std::vector<std::pair<int, const wchar_t *>> BASQUE_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays-ek ezin izan ditu zure kategoriak eta esaldiak gorde.\n\nZure aldaketa hemen ageri da oraindik, baina gal daiteke SimonSays ixtean. Esportatu zure taula F10 sakatuta kopia bat gordetzeko." },
...
static const std::vector<std::pair<int, const wchar_t *>> CATALAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays no ha pogut desar les teves categories i frases.\n\nEl teu canvi encara es mostra aquí, però es pot perdre en tancar SimonSays. Exporta el teu tauler amb F10 per conservar-ne una còpia." },
...
static const std::vector<std::pair<int, const wchar_t *>> CHINESE_SIMPLIFIED_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays 无法保存你的分类和短语。\n\n你的更改目前仍显示在这里，但关闭 SimonSays 后可能会丢失。请按 F10 导出板面以保留一份副本。" },
...
static const std::vector<std::pair<int, const wchar_t *>> FRENCH_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays n'a pas pu enregistrer vos catégories et vos phrases.\n\nVotre modification est toujours affichée ici, mais elle risque d'être perdue à la fermeture de SimonSays. Exportez votre tableau avec F10 pour en conserver une copie." },
...
static const std::vector<std::pair<int, const wchar_t *>> GALICIAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays non puido gardar as túas categorías e frases.\n\nO teu cambio aínda se mostra aquí, pero pode perderse ao pechar SimonSays. Exporta o teu taboleiro con F10 para conservar unha copia." },
...
static const std::vector<std::pair<int, const wchar_t *>> GERMAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays konnte Ihre Kategorien und Sätze nicht speichern.\n\nIhre Änderung wird hier noch angezeigt, kann aber beim Schließen von SimonSays verloren gehen. Exportieren Sie Ihr Board mit F10, um eine Kopie zu behalten." },
...
static const std::vector<std::pair<int, const wchar_t *>> HEBREW_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays לא הצליח לשמור את הקטגוריות והמשפטים שלך.\n\nהשינוי שלך עדיין מוצג כאן, אך הוא עלול לאבוד בסגירת SimonSays. ייצא את הלוח שלך באמצעות F10 כדי לשמור עותק." },
...
static const std::vector<std::pair<int, const wchar_t *>> HINDI_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays आपकी श्रेणियाँ और वाक्यांश सहेज नहीं सका।\n\nआपका बदलाव अभी यहाँ दिख रहा है, लेकिन SimonSays बंद करने पर वह खो सकता है। प्रतिलिपि रखने के लिए F10 से अपना बोर्ड निर्यात करें।" },
...
static const std::vector<std::pair<int, const wchar_t *>> ITALIAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays non è riuscito a salvare le tue categorie e frasi.\n\nLa tua modifica è ancora visibile qui, ma potrebbe andare persa alla chiusura di SimonSays. Esporta la tua tavola con F10 per conservarne una copia." },
...
static const std::vector<std::pair<int, const wchar_t *>> JAPANESE_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays はカテゴリとフレーズを保存できませんでした。\n\n変更はまだ表示されていますが、SimonSays を閉じると失われる可能性があります。F10 でボードをエクスポートして控えを残してください。" },
...
static const std::vector<std::pair<int, const wchar_t *>> KOREAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays가 카테고리와 문구를 저장하지 못했습니다.\n\n변경 내용은 아직 표시되어 있지만 SimonSays를 닫으면 사라질 수 있습니다. F10으로 보드를 내보내 사본을 보관하세요." },
...
static const std::vector<std::pair<int, const wchar_t *>> PORTUGUESE_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"O SimonSays não conseguiu guardar as suas categorias e frases.\n\nA sua alteração ainda é mostrada aqui, mas pode perder-se ao fechar o SimonSays. Exporte o seu quadro com F10 para guardar uma cópia." },
...
static const std::vector<std::pair<int, const wchar_t *>> PORTUGUESE_BRAZIL_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_TITLE_ID, L"Erro do SimonSays" },
  { ERROR_TASKBAR_POSITION_ID, L"O SimonSays atualmente suporta apenas a barra de tarefas inferior" },
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"O SimonSays não conseguiu salvar suas categorias e frases.\n\nSua alteração ainda aparece aqui, mas pode ser perdida ao fechar o SimonSays. Exporte sua prancha com F10 para guardar uma cópia." },
  { ADD_DIALOG_CATEGORY_TITLE_ID, L"Adicionar nova categoria" },
  { ADD_DIALOG_PHRASE_TITLE_ID, L"Adicionar nova frase" },
  { ADD_DIALOG_CATEGORY_TEXT_LABEL_ID, L"Nome da categoria :" },
  { ADD_DIALOG_PHRASE_TEXT_LABEL_ID, L"Texto da frase :" },
...
static const std::vector<std::pair<int, const wchar_t *>> RUSSIAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays не смог сохранить ваши категории и фразы.\n\nВаше изменение всё ещё показано здесь, но может быть потеряно при закрытии SimonSays. Экспортируйте доску клавишей F10, чтобы сохранить копию." },
...
static const std::vector<std::pair<int, const wchar_t *>> VALENCIAN_LOCALIZED_UI_STRINGS = {
  ...
  { ERROR_SAVE_FAILED_MESSAGE_ID, L"SimonSays no ha pogut desar les teues categories i frases.\n\nEl teu canvi encara es mostra ací, però es pot perdre en tancar SimonSays. Exporta el teu tauler amb F10 per conservar-ne una còpia." },
